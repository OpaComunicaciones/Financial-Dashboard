...
interface EditMiscIncomeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (income: MiscIncome) => void;
  income: MiscIncome | null;
}

const EditMiscIncomeModal: React.FC<EditMiscIncomeModalProps> = ({ isOpen, onClose, onSave, income }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg border border-gray-700">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-white">{t('daily_cash_edit_income_modal_title')}</h2>
...
export default EditMiscIncomeModal;
